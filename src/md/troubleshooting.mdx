...
- In Apple's display settings - Make sure that the retina dispaly is set to 'Main Display', and decimators are set to 'Extend'.
- Make sure the displays (Audiance and Stage) are both enabled in Pro-Presenter (2 green lights top right in ProPresenter)
