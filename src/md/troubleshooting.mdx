import Heading from "../components/heading/Heading"; import Header from "../components/header/Header";
...
<Heading as="h3" size="md">Camera's look really orange (umpa lumpa)</Heading>
